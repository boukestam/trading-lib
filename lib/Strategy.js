...
export function updateStrategy(provider, script, settings) {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                                ...
                                case 9:
                                    if (!openPositions.some(function (position) {
                                        return position.pair === pair &&
                                            ...
                                            Math.abs(Util.change(position.limit, limitPrice_1)) < 0.001;
                                    })) return [3 /*break*/, 10];
                ...
                case 11:
                    ...
                    return [4 /*yield*/, provider.closePosition(sorted[0], undefined, 1, 'Closed to make space for next trade')];
                case 12:
                    _d.sent();
